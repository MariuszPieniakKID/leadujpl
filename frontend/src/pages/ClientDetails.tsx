...
import api, { type Client, listClientOffers, listClientAttachments, downloadOffer, fetchOffer, type AttachmentItem, viewAttachmentUrl, downloadAttachmentUrl, getClientLatestStatus, setClientLatestStatus } from '../lib/api'
